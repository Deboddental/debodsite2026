...
export default function WhatsAppWidget() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      ...
      >
        <p className="font-outfit font-semibold text-charcoal text-sm whitespace-nowrap">{t('wa.help', locale)}</p>
        <p className="font-jakarta text-slate text-xs">{t('wa.book', locale)}</p>
      </div>

// English landing pages for international / expat patients in Madrid (dental
// tourism). Rendered by EnLandingPage.jsx at /en/<slug>/, with reciprocal
// hreflang to their Spanish counterpart (esAlternate).
...
- 💳 **Financing** up to 60 months, with a first diagnostic visit included.

Whether you are an expat in Madrid or visiting for treatment, we will tell you honestly what your case needs and what is realistic for your timeline.`,
    faqs: [
      { question: 'How much do dental implants cost in Madrid?', answer: 'The price depends on your case (number of implants, whether bone grafting is needed and the type of crown). We give you an exact, itemised quote at your first visit, with financing available up to 60 months. Book a diagnostic visit for a personalised estimate.' },
      ...
      { question: 'How long does the whole implant treatment take?', answer: 'It varies by case, but several months usually pass between placing the implant and fitting the final crown, to allow osseointegration. At your first visit we give you a personalised timeline — useful to plan if you are travelling.' },
      { question: 'Am I a candidate if I have lost bone?', answer: 'Often yes. When bone is insufficient, techniques such as alveolar bone grafting rebuild the volume needed to place the implant safely. We assess this with a 3D scan at your first visit.' },
    ],
  },
  {
    ...
    intro: `## Porcelain veneers & smile design in Madrid
...
- 💳 **Financing** available, first diagnostic visit included.

Ideal for expats and visitors who want a premium, natural-looking smile in the heart of Madrid.`,
    faqs: [
      { question: 'How much do porcelain veneers cost in Madrid?', answer: 'The price depends on how many veneers you need and your case. We provide a clear, itemised quote at your first visit, with financing available. Because results are designed digitally first, you know exactly what you are getting before starting.' },
      ...
      { question: 'How many visits do veneers take?', answer: 'Typically a few visits: the digital smile design and preparation, then fitting the final veneers. With our in-house lab we keep timelines short — tell us your dates if you are visiting Madrid and we will plan around them.' },
    ],
  },
]

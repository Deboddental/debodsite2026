...
It begins with a **free online video consultation**. Send us recent photos and any X-rays by **WhatsApp (+34 689 10 47 14)** or email **info@deboddentalclinic.com**, and we will review your case and reply with first guidance and an estimated plan — with no obligation.`,
    faqs: [
      { question: 'How much can I save with dental treatment in Madrid?', answer: 'High-quality private dental care in Spain typically costs considerably less than equivalent treatment in the UK, Ireland or the US, while using premium materials and the same digital technology. We do not publish fixed prices because every case is different — book a free video consultation and we will send you a clear, itemised quote with no obligation.' },
...
Whether you are an expat in Madrid or travelling for treatment, we will tell you honestly what your case needs and what is realistic for your timeline.`,
    faqs: [
      { question: 'How much do dental implants cost in Madrid?', answer: 'The price depends on your case (number of implants, whether bone grafting is needed and the type of crown). For international patients, implants in Madrid are typically far more affordable than in the UK, Ireland or the US. Book a free video consultation for a clear, itemised quote with no obligation.' },
...
We will tell you honestly whether All-on-4, All-on-6 or another solution best fits your case — after a proper 3D assessment.`,
    faqs: [
      { question: 'How much does All-on-4 cost in Madrid?', answer: 'All-on-4 is quoted per arch and depends on your case and the materials chosen for the final bridge. For international patients it is typically far more affordable in Madrid than in the UK, Ireland or the US. Book a free video consultation for an itemised, no-obligation quote.' },
...
After a 3D assessment we will recommend honestly whether All-on-6, All-on-4 or another approach is best for your bone and your goals.`,
    faqs: [
      ...
      { question: 'How much does All-on-6 cost in Madrid?', answer: 'All-on-6 is quoted per arch and depends on your case and the final materials. For international patients it is typically much more affordable in Madrid than in the UK, Ireland or the US. Book a free video consultation for an itemised, no-obligation quote.' },
...
Ideal for expats and visitors who want a premium, natural-looking smile in the heart of Madrid — often completed in just a few days.`,
    faqs: [
      { question: 'How much does cosmetic dentistry cost in Madrid?', answer: 'It depends on the treatment (veneers, whitening, crowns or a full smile makeover) and how many teeth are involved. For international patients, cosmetic work in Madrid is typically much more affordable than in the UK, Ireland or the US. Book a free video consultation for a clear, itemised quote.' },
...
Ideal for expats and visitors who want a premium, natural-looking smile — often completed in just a few days in the heart of Madrid.`,
    faqs: [
      { question: 'How much do porcelain veneers cost in Madrid?', answer: 'The price depends on how many veneers you need and your case. For international patients, porcelain veneers in Madrid are typically far more affordable than in the UK, Ireland or the US. Because results are designed digitally first, you know exactly what you are getting before starting — book a free video consultation for an itemised quote.' },
...
Perfect for expats and visitors who want a confident, natural smile — often achieved in just a few days in the heart of Madrid.`,
    faqs: [
      ...
      { question: 'How much does a smile makeover cost in Madrid?', answer: 'It depends on which treatments your makeover combines and how many teeth are involved. For international patients it is typically much more affordable in Madrid than in the UK, Ireland or the US. Book a free video consultation for a clear, itemised quote.' },
